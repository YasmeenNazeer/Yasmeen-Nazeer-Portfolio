      ...
      <section id="contact" className="py-40 px-4 md:px-8 bg-[#1a1a1a]">
        <div className="text-center text-white">
          <h4 className="text-4xl lg:text-5xl font-[Caveat]">
            <span>
              <span className="text-[#55DDE0] ">C</span>ontact{' '}
              <span className="text-[#55DDE0] ">M</span>e
            </span>
          </h4>
          ...
          <div className="mt-24 flex flex-col lg:flex-row justify-evenly items-start">
            ...
            <div className="flex flex-col justify-center items-start text-center">
              ...
              <div className="flex mb-12 items-start">
                <MdEmail className="text-2xl text-[#55DDE0] mr-4" />
                <div className="text-start">
                  <p className="text-white">Have a question?</p>
                  <p className="my-2 text-[#8d8d8d]">I am here to help you</p>
                  <p className="text-[#55DDE0] ">Email me at Yasmeen@mail.com</p>
                </div>
              </div>

              <div className="flex mb-12 items-start">
                <MdLocationOn className="text-2xl text-[#55DDE0] mr-4" />
                <div className="text-start">
                  <p className="text-white">Current Location</p>
                  <p className="my-2 text-[#8d8d8d]">Karachi, Pakistan</p>
                  <p className="text-[#55DDE0] ">serving clients worldwide</p>
                </div>
              </div>
            ...
            <form className="w-full lg:w-[50%] flex flex-col items-start">
              ...
              <Link href="#home" className="py-3 px-8 rounded-lg text-2xl text-black bg-[#55DDE0] transition hover:bg-[#428e8e]  mt-4">
                Send message
              </Link>
            </form>
          </div>
